...
{
    public class PuzzleResultsController : IResultsController
    {
        ...
        public async UniTask EndGame(Transform target = null, Quaternion rotation = new Quaternion(), CancellationToken token = default(CancellationToken))
        {
